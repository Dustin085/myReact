function Carousel() {
    ...
    // Slide元件
    function Slide({ index, imgUrl }) {
        return <figure className="slide" style={index == activeSlide ? { opacity: 1 } : { opacity: 0 }}><img src={imgUrl} alt="" /></figure>
    }
            ...
            <div className="slide-box">
                {
                    slideUrls.map((slideUrl, index) => {
                        return <Slide key={index} index={index} imgUrl={slideUrl} />
                    })
                }
                {/*
